//! Coordination server FFI (`ghal_bol_core_ffi_coord_*`).
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_coord_set_base_url(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_coord_lookup_peer(
    config_json_utf8: *const c_char,
) -> *mut c_char {
    let run = || -> *mut c_char {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_coord_register_now() -> *mut c_char {
