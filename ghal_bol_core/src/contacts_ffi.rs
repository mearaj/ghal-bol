...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_contacts_change_version() -> *mut c_char {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_contacts_list(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_contacts_upsert(
    app_namespace_utf8: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_contacts_remove(
    app_namespace_utf8: *const c_char,
    contact_json_utf8: *const c_char,
) -> *mut c_char {
    let run = || -> *mut c_char {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_contacts_find(
    app_namespace_utf8: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_contacts_merge_discovered_peer_id(
    app_namespace_utf8: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_contacts_record_inbound_preview(
    app_namespace_utf8: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_contacts_set_trust(
    app_namespace_utf8: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_contacts_clear_unread(
    app_namespace_utf8: *const c_char,
    public_key_hex_utf8: *const c_char,
) -> *mut c_char {
    let run = || -> *mut c_char {
