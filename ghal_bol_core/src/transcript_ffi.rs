...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_transcript_resolve_path(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_transcript_load_merged(
    app_namespace_utf8: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_transcript_save(
    app_namespace_utf8: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_transcript_append_if_new(
    app_namespace_utf8: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_transcript_patch_outgoing_delivery(
    app_namespace_utf8: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_transcript_patch_inbound_read_ack_sent(
    app_namespace_utf8: *const c_char,
    patch_json_utf8: *const c_char,
) -> *mut c_char {
    let run = || -> *mut c_char {
