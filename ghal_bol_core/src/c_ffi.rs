...
//!
//! Symbols: **`ghal_bol_core_ffi_string_free`**, **`ghal_bol_core_ffi_configure_android_data_directory`**,
//! **`ghal_bol_core_ffi_create_or_unlock_identity`**, **`ghal_bol_core_ffi_import_identity_from_secret_hex`**,
//! **`ghal_bol_core_ffi_reveal_secret_key_hex`**, **`ghal_bol_core_ffi_export_keystore_json`**,
//! **`ghal_bol_core_ffi_import_keystore_json`**, **`ghal_bol_core_ffi_reset_first_time_identity`**, **`ghal_bol_core_ffi_keystore_exists`**, **`ghal_bol_core_ffi_lock`**,
//! **`ghal_bol_core_ffi_delete_keystore`**,
//! **`ghal_bol_core_ffi_verify_ghal_bol_connect_invite`**, **`ghal_bol_core_ffi_peer_id_from_public_key_hex`**,
//! **`ghal_bol_core_ffi_public_key_hex_from_peer_id`**,
//! **`ghal_bol_core_ffi_seal_utf8_to_public_key_hex`**,
//! **`ghal_bol_core_ffi_peer_display_alias_get`**, **`ghal_bol_core_ffi_peer_display_alias_set`**.
//! (Shipped as **`lib_ghal_bol_core.so`** on Linux/Android — built as `libghal_bol_core.so`, renamed in sync/pack scripts.)
...
/// Same paths as [`ghal_bol_core_ffi_configure_android_data_directory`] (P2P `:p2p` process).
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_string_free(ptr: *mut c_char) {
    if ptr.is_null() {
        return;
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_create_or_unlock_identity(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_import_identity_from_secret_hex(
    app_namespace_utf8: *const c_char,
    password_utf8: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_reveal_secret_key_hex(
    app_namespace_utf8: *const c_char,
    password_utf8: *const c_char,
) -> *mut c_char {
    let run = || -> *mut c_char {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_export_keystore_json(
    app_namespace_utf8: *const c_char,
) -> *mut c_char {
    let run = || -> *mut c_char {
        let ns = match unsafe { utf8_trace(app_namespace_utf8, "app_namespace") } {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_import_keystore_json(
    app_namespace_utf8: *const c_char,
    password_utf8: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_reset_first_time_identity(
    app_namespace_utf8: *const c_char,
) -> *mut c_char {
    let run = || -> *mut c_char {
        let ns = match unsafe { utf8_trace(app_namespace_utf8, "app_namespace") } {
...
/// using the same storage paths as [`ghal_bol_core_ffi_create_or_unlock_identity`].
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_keystore_exists(
    app_namespace_utf8: *const c_char,
) -> *mut c_char {
    let run = || -> *mut c_char {
        let ns = match unsafe { utf8_trace(app_namespace_utf8, "app_namespace") } {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_daemon_socket_path() -> *mut c_char {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_lock() {
    crate::session_runtime::lock_identity();
}

/// Delete persisted keystore + preferences after verifying [password_utf8] unlocks the keystore.
/// Clears the in-memory session. Caller should stop P2P before calling (e.g. [`ghal_bol_core_ffi_p2p_stop`]).
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_delete_keystore(
    app_namespace_utf8: *const c_char,
    password_utf8: *const c_char,
) -> *mut c_char {
    let run = || -> *mut c_char {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_peer_display_alias_get(
    app_namespace_utf8: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ghal_bol_core_ffi_peer_display_alias_set(
    app_namespace_utf8: *const c_char,
    public_key_hex_utf8: *const c_char,
