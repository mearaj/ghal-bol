...
//!
//! Spawns TWO secp256k1 libp2p nodes (same stack as the ghal_bol_core client):
...
//!
//! Usage:
//!   cargo run -p ghal_bol_coord --example circuit_test -- <relay-base-addr> <relay-peer-id>
//!   e.g. cargo run -p ghal_bol_coord --example circuit_test -- \
