...
//! behaviour set + transport as the ghal_bol client, then stays alive to accept incoming
...
//!
//! Usage:
//!   cargo run -p ghal_bol --example relay_responder -- <relay-base-addr> <relay-peer-id>
