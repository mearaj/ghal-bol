...
#
#   ./ghal_bol_server/deploy/certbot_coord1.sh          # check + nginx only
#   ./ghal_bol_server/deploy/certbot_coord1.sh --issue   # new cert (needs DNS TXT at GoDaddy)
set -euo pipefail
...
echo "Run: ./ghal_bol_server/deploy/certbot_coord1.sh --issue" >&2
exit 1
